...
export const ModalSuccess = ({ data, setData, bottom }: { data: any; setData: any; bottom: any }) => {
    return (
...
export const ModalFailed = ({ data, setData, bottom }: { data: any; setData: any; bottom: any }) => {
    return (
        <Transition.Root show={data.open} as={Fragment}>
            <Dialog
                as="div"
...
export const ModalStatus = ({
    ...
    if (status) {
        return <ModalSuccess data={data} setData={setData} bottom={bottom} />;
    }

    return <ModalFailed data={data} setData={setData} bottom={bottom} />;
};
